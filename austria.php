...
<html>
  ...
  <body>
      ...
      <section id="main_dest" style="background: url('image/austria5.jpg') top;">
          <div class="wrapper">
              <h2>Destination</h2>
          </div>
      </section>
      ...
      <section id="detphotos">
          <div class="wrapper">
          <div id="detp1">
              <img src="image/aus1.jpg" >
          </div>
          <div id="det23">
              <ul>
                  <li><img src="image/aus2.jpg" ></li>
                  <li><img src="image/aus3.webp" ></li>
              </ul>
          </div>
          </div>
          <div class="clear"></div>
      ...
      <section id="conteneur">
          <div class="wrapper">
              <section id="lf">
                  ...
                  <h1>Honouring History <br>and Heritage in Austria</h1>
                  </div>
                  <div id="part2">
                      <ul>
                      ...
                      <div id="change">
                          <h5>🏔️ Austria – The Heart of Europe</h5>
                          <p id="description" class="active">
                              Austria is a breathtaking destination where snow-capped Alps meet imperial palaces,
                              and rich musical heritage blends with vibrant modern culture. Nestled in Central Europe,
                              this enchanting country is known for its stunning landscapes, historic cities, and world-famous art and music scenes.
                          </p>
                          <p id="features" class="hidden">
                              Austria dazzles with a mix of natural beauty and cultural treasures. From the majestic Schönbrunn Palace and Salzburg's baroque old town to the alpine wonders of Innsbruck and Hallstatt, there's something for every traveler.
                              Highlights include Vienna's State Opera, the Hofburg Palace, the Danube Valley, and ski resorts like St. Anton.
                          </p>
                          <p id="virtual" class="active">
                              Before you visit, Austria invites you to explore its magic online. Take virtual tours of Vienna's Kunsthistorisches Museum,
                              stroll through Salzburg's Mirabell Gardens via 360° videos, or enjoy a digital concert at the Vienna Philharmonic.
                          </p>
                          <p id="price" class="hidden">
                              Austria caters to both luxury seekers and budget travelers. A 4-day mid-range trip (flights, hotels, and sightseeing) averages 
                              800–1,500 USD per person. High-end stays in 5-star hotels or ski resorts can exceed $2,000 USD
                          </p>
                      </div>
                  </div>
