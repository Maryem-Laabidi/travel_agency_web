...
<html>
    ...
    <body>
        ...
        <section id="main_dest" style="background: url('image/india3.jpg') no-repeat;">
            <div class="wrapper">
                <h2>Destination</h2>
        ...
        <section id="detphotos">
            <div class="wrapper">
            <div id="detp1">
                <img src="image/newd11.png" >
            </div>
            <div id="det23">
                <ul>
                    <li><img src="image/d12.jpg" ></li>
                    <li><img src="image/d13.webp" ></li>
                </ul>
        ...
        <section id="lf">
                ...
                <h1>Honouring History <br>and Heritage in Pahalgam</h1>
            ...
            <div id="part2">
                ...
                <div id="change">
                    <h5>🌲 Pahalgam-The Valley of Shepherds</h5>
                    <p id="description" class="active">
                    
                        Nestled in the heart of Kashmir, Pahalgam is a serene hill station known for its lush green meadows,
                         dense pine forests, and snow-covered peaks. Located along the banks of the Lidder River, 
                        it's the perfect escape for nature lovers, adventure seekers, and those craving peace.
    
                    </p>
                    
                    <p id="features" class="hidden">
                        Pahalgam is a heaven for outdoor enthusiasts and peace-seekers alike. 
                        Surrounded by dense pine forests and majestic Himalayan peaks, it offers a wide range of activities including hiking,
                         trout fishing, river rafting, and pony rides. 
                        With its calm rivers and fresh mountain air, Pahalgam is ideal for both adventure and relaxation.
                    </p>
                    <p id="virtual" class="active">
                        Even before setting foot in Pahalgam, travelers can enjoy a taste of its beauty through immersive 
                        360° virtual tours and drone videos that showcase the valleys,
                         rivers, and surrounding snow-clad mountains. Many travel platforms offer virtual walks through the village, 
                         giving you a chance to experience the ambiance,
                          explore local attractions, and plan your trip visually.
                        
                    </p>

                    <p id="price" class="hidden">
                        Travel to Pahalgam remains fairly affordable compared to other global mountain destinations. 
                        Over the past five years, the average cost for a 3-day trip has ranged between $150 to $250 USD per person, 
                        including mid-range accommodation and local transport. During peak seasons like summer 
                        and Amarnath Yatra, prices tend to rise slightly. 
                    </p>
                </div>
