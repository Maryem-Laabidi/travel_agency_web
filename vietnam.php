...
<html>
    ...
    <body>
        ...
        <section id="main_dest" style="background: url('image/vietnam3.jpg') top ;">
            <div class="wrapper">
                <h2>Destination</h2>
        ...
        <section id="detphotos">
            <div class="wrapper">
            <div id="detp1">
                <img src="image/viet1.jpeg" >
            </div>
            <div id="det23">
                <ul>
                    <li><img src="image/viet2.jpg" ></li>
                    <li><img src="image/viet3.jpg" ></li>
                </ul>
        ...
        <section id="lf">
                ...
                <h1>Honouring History <br>and Heritage in Vietnam</h1>
            ...
            <div id="part2">
                ...
                <div id="change">
                    <h5>🏮 Vietnam – Where Tradition Meets Adventure</h5>
                    <p id="description" class="active">
                    
                        Vietnam is a mesmerizing blend of ancient temples, emerald rice terraces, and bustling cities humming with motorbikes and markets. From the misty peaks of Sapa to the turquoise
                         waters of Ha Long Bay, this Southeast Asian gem offers rich history, vibrant street life, and unforgettable flavors.
                    </p>
                    
                    <p id="features" class="hidden">
                        Vietnam packs endless wonders into its slender shape: the lantern-lit streets of Hoi An, the wartime tunnels of Cu Chi, and the towering limestone karsts of Ninh Binh. Foodies
                         feast on pho, banh mi, and fresh spring rolls, while adventurers trek Mai Chau's valleys or kayak in Ha Long Bay. 
                    </p>
                    <p id="virtual" class="active">
                        Dive into Vietnam's magic before you go! Take 360° tours of the Son Doong Cave (the world's largest), wander Hoi An's night market via livestream, or join a virtual cooking class to master pho. 
                        Google Arts & Culture offers digital walks through Hanoi's temples, while drone videos showcase Ha Long Bay's sunrise.
                        
                    </p>

                    <p id="price" class="hidden">
                        To stretch your budget further, book flights early (especially 
                        for peak seasons like December or April) and opt for overnight trains/buses between cities. Street food costs just
                        1-3 USD.
                    </p>
                </div>
