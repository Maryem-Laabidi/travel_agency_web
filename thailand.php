...
<html>
    ...
    <body>
        ...
        <section id="main_dest" style="background: url('image/thailand7.jpg') top;">
            <div class="wrapper">
                <h2>Destination</h2>
        ...
        <section id="detphotos">
            ...
            <div id="det23">
                <ul>
                    <li><img src="image/th2.webp" ></li>
                    <li><img src="image/th4.webp" ></li>
                </ul>
        ...
        <section id="lf">
                ...
                <h1>Honouring History <br>and Heritage in Thailand</h1>
            ...
            <div id="part2">
                ...
                <div id="change">
                    <h5>🌴 Thailand – The Land of Smiles</h5>
                    <p id="description" class="active">
                        Thailand is a dazzling mix of golden temples, neon-lit cities, and paradise islands with water so blue it looks 
                        photoshopped. From the chaotic energy of Bangkok to the peaceful jungles
                         of Chiang Mai and the powdery beaches of Phuket, this Southeast Asian kingdom offers something for every traveler.
                    </p>
                    
                    <p id="features" class="hidden">
                        Thailand thrills with contrasts: the Grand Palace's glittering spires, the floating markets of Damnoen Saduak,
                         and the full moon parties of Koh Phangan. Adrenaline junkies can rock-climb Railay Beach
                         or cage-dive with sharks in Chumphon, while culture lovers explore Ayutthaya's ruins or meditate at Doi Suthep temple.
                    </p>
                    <p id="virtual" class="active">
                        Get a taste of Thailand before you go! Take a 360° tour of Wat Arun at golden hour, "walk" through Chatuchak Market's 15,000 stalls via Google Street View, or join a live-streamed Muay Thai match. Virtual cooking
                         classes teach you to make authentic green curry, while drone footage lets you soar over the iconic Phi Phi Islands.
                        
                    </p>

                    <p id="price" class="hidden">
                        Thailand is famously budget-friendly. A 10-day trip averages 600-1.200 USD for mid-range hotels, meals, and tours.
                        Peak season (November–February) sees higher prices, especially around Christmas. Visit in shoulder seasons 
                        (April–June or September–October) for fewer crowds and discounts up to 40%.
                    </p>
                </div>
