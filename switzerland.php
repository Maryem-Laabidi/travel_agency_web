...
<html>
    ...
    <body>
        ...
        <section id="main_dest" style="background: url('image/swit.jpg') center;">
            <div class="wrapper">
                <h2>Destination</h2>
        ...
        <section id="detphotos">
            ...
            <div id="det23">
                <ul>
                    <li><img src="image/sw2.jpg" ></li>
                    <li><img src="image/sw3.jpg" ></li>
                </ul>
        ...
        <section id="lf">
                ...
                <h1>Honouring History <br>and Heritage in Switzerland</h1>
            ...
            <div id="part2">
                ...
                <div id="change">
                    <h5>🏔️ Switzerland – Where Alpine Dreams Come True</h5>
                    <p id="description" class="active">
                    
                        Switzerland is a breathtaking symphony of snow-dusted peaks, emerald valleys, and glittering lakes that look straight out of a fairy tale. 
                        This alpine paradise blends postcard-perfect landscapes with sophisticated cities, where precision meets natural wonder.
    
                    </p>
                    
                    <p id="features" class="hidden">
                        Switzerland spoils travelers with world-class attractions: the iconic Matterhorn, Jungfraujoch's "Top of Europe," and the palm-fringed shores of Lugano.
                         Thrill-seekers can paraglide over Interlaken, hike the Eiger Trail, or tackle the Via Ferrata in Zermatt. 
                    </p>
                    <p id="virtual" class="active">
                        Before packing your bags, experience Switzerland's magic from home through incredible digital platforms. The Swiss tourism board offers stunning 360° virtual tours that let you stand on the Jungfraujoch glacier,
                         walk across Lucerne's famous Chapel Bridge, or explore the medieval halls of Château de Chillon.
                        
                    </p>

                    <p id="price" class="hidden">
                        While Switzerland is known for its premium prices, strategic planning makes it accessible. For budget-conscious travelers, hostels start around CHF 35/night, and supermarket meals (Coop/Migros) keep food costs to CHF 15-20/day. Mid-range travelers
                         should budget CHF 150-250/day for comfortable 3-star hotels, regional train passes, and occasional restaurant meals.
                    </p>
                </div>
        ...
        <section class="offer">
            <div class="wrapper">
                <div id="par1">
                    ...
                    <p>we bring you the best travel deals to make your trips affordable and unforgettable.
        ...
        <script>
            // Update the BASE_PRICE constant to match the PHP price
            document.addEventListener('DOMContentLoaded', function() {
                window.BASE_PRICE = <?= $one_night_price ?>;
            });
        </script>
    </body>
</html>
